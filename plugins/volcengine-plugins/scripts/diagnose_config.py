...
from volcengine_plugins.config import CONFIG_NAMES, USER_ENV_SWITCH
...
async def run(user_only: bool):
    ...
    params = StdioServerParameters(command=sys.executable, args=["-m", "volcengine_plugins"], env=env)
