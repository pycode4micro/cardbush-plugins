...
from volcengine_plugins.video_client import SeedanceClient
from volcengine_plugins.video_models import VideoRequest, VideoLocalOptions
...
def test_only_download_get_is_retried(tmp_path,monkeypatch):
    ...
    monkeypatch.setattr('volcengine_plugins.task_io.asyncio.sleep',no_sleep)
    cdn=[]
    def handler(request):
