...
def main():
    ...
    for folder in [".codex-plugin", ".claude-plugin", "src/volcengine_plugins", "tests", "docs", "examples", "scripts"]:
    ...
    files.extend(root / name for name in [
        "assets/logo.png", "assets/icon.png", "src/volcengine_plugins/assets/icon.png"])
